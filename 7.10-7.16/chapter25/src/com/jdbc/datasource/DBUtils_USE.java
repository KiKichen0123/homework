...
public class DBUtils_USE {
    ...
    public void testQueryMany() throws SQLException { //返回结果是多行的情况
        ...
        //1. 得到 连接 (druid)
        Connection connection = com.jdbc.datasource.JDBCUtilsByDruid.getConnection();
         ...
         *     }
         */
        List<com.jdbc.datasource.Actor> list =
                queryRunner.query(connection, sql, new BeanListHandler<>(com.jdbc.datasource.Actor.class), 1);
        System.out.println("输出集合的信息");
        for (com.jdbc.datasource.Actor actor : list) {
            System.out.print(actor);
        }


        //释放资源
        com.jdbc.datasource.JDBCUtilsByDruid.close(null, null, connection);
    ...
    public void testQuerySingle() throws SQLException {
        ...
        com.jdbc.datasource.Actor actor = queryRunner.query(connection, sql, new BeanHandler<>(com.jdbc.datasource.Actor.class), 10);

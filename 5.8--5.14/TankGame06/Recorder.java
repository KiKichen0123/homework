 ...
 * 在恢复游戏的时候通过Node的Vector去恢复敌人坦克的位置和方向
 */
...
//    private static Vector<Node> nodes = new Vector<>;
    ...
    //对keepRecord 进行升级，保存存活敌人坦克的坐标和方向
    public static void keepRecord(){    //存盘退出时候，调用这个方法
        try {
            bw = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(recordFile),"utf-8"));
            bw.write(allEnemyTankNum + "");
            bw.newLine();
            //遍历敌人坦克的Vector,如何根据情况保存即可
